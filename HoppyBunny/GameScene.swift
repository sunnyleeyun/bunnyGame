...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        /* Play SFX */
        let flatSFX = SKAction.playSoundFileNamed("sfx_flap", waitForCompletion: false)
        self.runAction(flatSFX)
    }
    ...
    override func update(currentTime: CFTimeInterval) {
        ...
        /* Press world scrolling */
        scrollWorld()
        
        /* Process obstacles */
        updateObstacles()
        
        /* Update last touch timer of obstacle */
